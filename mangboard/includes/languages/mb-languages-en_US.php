...
$mb_languages["MSG_FIELD_EMPTY_ERROR1"]	= "Please enter your %s";
$mb_languages["MSG_FIELD_EMPTY_ERROR2"]	= "Please enter your %s";
...
$mb_languages["MSG_MOVE_SELECT_EMPTY"]	= "Please select the item(s) to move.";
$mb_languages["MSG_COPY_SELECT_EMPTY"]	= "Please select the item(s) to copy.";
$mb_languages["MSG_DELETE_SELECT_EMPTY"]	= "Please select the item(s) to delete.";
$mb_languages["MSG_DELETE_CONFIRM"]	= "Are you sure you want to delete this item?";
$mb_languages["MSG_PASSWD_INPUT"]	= "Please enter your password.";
		
$mb_languages["MSG_MULTI_DELETE_CONFIRM"]	= " item(s), Are you sure you want to delete?";
$mb_languages["MSG_MULTI_MOVE_CONFIRM"]	= " item(s), Do you want to move selected?";
$mb_languages["MSG_MULTI_COPY_CONFIRM"]	= " item(s), Do you want to copy selected?";
...
$mb_languages["W_USER_NAME"]	= "Name";	
$mb_languages["W_USER_NAME_PID"]	= "User Name [Pid]";
$mb_languages["W_WRITER"]	= "Name";
...
$mb_languages["W_VOTE_GOOD"]		= "Like";	
$mb_languages["W_VOTE_BAD"]			= "Not Like";	
...
$mb_languages["W_SHOW_LIST_SEARCH"]	= "Show a list search";
...
$mb_languages["W_LIST_TITLE_LABEL"]		= "Use(selective), Use(all), Nonuse";
...
$mb_languages["W_FACEBOOK_PIXEL_ID"]				= "Facebook Pixel ID";
$mb_languages["W_NAVER_SITE_VERIFICATION"]		= "Naver Site Verification";
$mb_languages["W_GOOGLE_SITE_VERIFICATION"]	= "Google Site Verification";


$mb_languages["W_COPY_PREVENTION"]	= "Contents Copy Prevention";
$mb_languages["W_ANTI_SPAM"]	= "Anti-Spam";
...
$mb_languages["W_EDIT_USER_INFO"]	= "Edit user’s information";
...
$mb_languages["W_ON_OFF2"]					= "On,Off";
$mb_languages["W_ON_OFF3"]					= "On,Off";
$mb_languages["W_OFF_ON"]						= "Off,On";
$mb_languages["W_OFF_ON2"]					= "Off,On";
$mb_languages["W_OFF_ON3"]					= "Off,On";
...
$mb_languages["W_SEARCH_FIELD"]									= "Search Field";
$mb_languages["W_SEARCH_TEXT"]									= "Search Text";
$mb_languages["W_SEO_DEFAULT_IMAGE"]							= "SEO Default Image";
$mb_languages["MSG_SEO_DEFAULT_IMAGE_DESC"]				= "";
$mb_languages["MSG_INSTALL_PERMISSION_ERROR"]			= "You have no authority to install";
$mb_languages["MSG_INSTALL_VERSION_ERROR"]				= "To proceed with the installation, please proceed with the update from the mangboard dashboard.";	
$mb_languages["MSG_INSTALL_SELECT_PRODUCT"]				= "Do you want to install the selected item?";
$mb_languages["MSG_DELETE_SELECT_PRODUCT"]				= "Do you want to delete the selected item?";
$mb_languages["MSG_DELETE_TEXT1"]								= "Product has been removed";
$mb_languages["MSG_REQUIRED_WORDPRESS_IMPORTER"]	= "Wordpress-Importer plugin installation required";
$mb_languages["MSG_STORE_MOVE"]									= "Store Page";
$mb_languages["MSG_FACEBOOK_PIXEL_ID_DESC"]				= "";
$mb_languages["MSG_NAVER_ANALYTICS_ID_DESC"]				= "";
$mb_languages["MSG_GOOGLE_ANALYTICS_ID_DESC"]			= "";
$mb_languages["MSG_NAVER_SITE_VERIFICATION_DESC"]		= "";
$mb_languages["MSG_GOOGLE_SITE_VERIFICATION_DESC"]		= "";

//Editor Composer
$mb_languages["W_ECOMPOSER_EXCEPT_BOARD"]				= "Editor Composer Except Board";
$mb_languages["W_ECOMPOSER_USE_BOARD"]					= "Editor Composer Use Board";
$mb_languages["W_ECOMPOSER_USE_LEVEL"]						= "Editor Composer Use Level";
$mb_languages["MSG_ECOMPOSER_EXCEPT_BOARD_DESC"]	= "";
$mb_languages["MSG_ECOMPOSER_USE_BOARD_DESC"]		= "";
$mb_languages["MSG_ECOMPOSER_USE_LEVEL_DESC"]			= "";

$mb_languages["W_MAX_WIDTH"]									= "Max Width";
$mb_languages["W_ROW_COUNT"]									= "Row";
$mb_languages["W_ALIGN"]											= "Align";
$mb_languages["W_FORM_SUBMIT"]									= "Submit";
$mb_languages["MSG_ECOMPOSER_MAX_WIDTH_TITLE"]	= "Max Width";
$mb_languages["MSG_ECOMPOSER_ROW_COUNT_TITLE"]	= "Row Count";
$mb_languages["MSG_ECOMPOSER_ALIGN_TITLE"]			= "Text Align";

$mb_languages["MSG_ECOMPOSER_INSERT_LAYOUT"]		= "Insert responsive layout into the editor";
$mb_languages["MSG_ECOMPOSER_EXPAND_PANELS"]		= "Expand Panels";
$mb_languages["MSG_ECOMPOSER_COLLAPSE_ICONS"]	= "Collapse to Icons";

$mb_languages["MSG_ECOMPOSER_INNER_BOX_DESC"]	= "Text Box";
$mb_languages["MSG_ECOMPOSER_OUTER_BOX_DESC"]	= "Responsive Box";
$mb_languages["MSG_ECOMPOSER_WRAP_BOX_DESC"]	= "Wrap Box";
$mb_languages["MSG_ECOMPOSER_DOTTED_DESC"]		= "Guides shown as dotted lines only appear on the post page";

//Board Item
$mb_languages["MSG_SECRET_CONTENT_DISPLAY_ERROR"]	= "The secret article cannot be displayed";
$mb_languages["MSG_PRIVATE_CONTENT_DISPLAY_ERROR"]	= "Private content cannot be displayed";
$mb_languages["MSG_BOARD_CONTENT_DISPLAY_ERROR"]	= "Only the content of the general bulletin board can be displayed";
$mb_languages["MSG_BOARD_CONTENT_LEVEL_ERROR"]		= "Only bulletin board with list and view permission set to 0 can be displayed";

$mb_languages["MSG_PASSWD_MODIFY"]		= "Your password has been changed";
$mb_languages["W_SAVE_EXCEL"]				= "Save Excel";
$mb_languages["MSG_SAVE_EXCEL_DESC"]		= "Save searched or selected members as Excel file";
$mb_languages["W_VIDEO"]						= "Video";
$mb_languages["W_VIDEO_INSERT"]				= "ADD VIDEO";
$mb_languages["MSG_VIDEO_INSERT_ERROR"]	= "Please enter the video URL address or iframe source";

$mb_languages["MSG_UPDATE_LATEST_VERSION"]	= "There is an update to the latest version(%s).";
$mb_languages["MSG_UPDATE_CONFIRM2"]			= "Do you want to proceed with the update?";

$mb_languages["W_BG_COLOR"]				= "Background Color";

$mb_languages["W_REGION"]					= "Region";
$mb_languages["W_MAP"]						= "Map";
$mb_languages["W_MAP_SEARCH"]			= "Search";
$mb_languages["W_CLOSE"]					= "Close";

$mb_languages["W_COORDINATES"]			= "Coordinates";
$mb_languages["W_LATITUDE"]				= "Latitude";
$mb_languages["W_LONGITUDE"]			= "Longitude";

$mb_languages["MSG_SEARCH_RESULT"]	= "%s Items were found";

$mb_languages["W_RESERVED_DATE"]				= "Date";
$mb_languages["W_RESERVED_TIME"]				= "Time";
$mb_languages["W_NUMBER_OF_PEOPLE"]			= "Number of people";
$mb_languages["W_APPLY"]							= "Apply";

$mb_languages["MSG_PRIVACY_POLICY_TEXT"]		= "I agree to collect and use personal information";
$mb_languages["MSG_PRIVACY_POLICY_ERROR"]		= "Please agree to collect and use personal information";
?>