<?php
$mb_board_upload_files			= array("jpg","jpeg","png","gif","bmp","zip","ppt","xls","doc","pptx","xlsx","docx","pdf","hwp","hwpx","psd","ai","mp3","mp4","txt","gz","dwg","stp","wav","wmv","mpg","mpeg","webm");
...
$mb_basic_params			= array("board_name"=>"","skin_name"=>"","mode"=>"","board_action"=>"","board_pid"=>"","parent_pid"=>"","prev_pid"=>"","parent_user_pid"=>"","user_pid"=>"","comment_pid"=>"","search_field"=>"fn_title","search_text"=>"","search_add_field1"=>"","search_add_text1"=>"","search_add_field2"=>"","search_add_text2"=>"","search_add_field3"=>"","search_add_text3"=>"","order_by"=>"fn_pid","order_type"=>"desc","category1"=>"","category2"=>"","category3"=>"","board_gid"=>"","board_page"=>1,"page_size"=>"","access"=>"","search_name"=>"","search_date"=>"","start_date"=>"","end_date"=>"","search_year"=>"","search_month"=>"","search_day"=>"","date_field"=>"","list_type"=>"","view_type"=>"","write_type"=>"","comment_type"=>"","calendar_date"=>"","template"=>"","template_class"=>"","mb_locale"=>"","lang"=>"","idx"=>"","step"=>"","stag"=>"","stype1"=>"","stype2"=>"","stype3"=>"");
?>