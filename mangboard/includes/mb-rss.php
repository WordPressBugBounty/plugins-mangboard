...
<rss version="2.0"
	...
	<channel>
		<title><?php echo esc_xml(get_bloginfo_rss('name'));?></title>
		<link><?php echo esc_url_raw(get_bloginfo_rss('url'));?></link>
...
?>
		<item>
			<author><![CDATA[<?php echo esc_xml(mbw_get_board_item('fn_user_name',false));?>]]></author>
			<category><![CDATA[<?php echo esc_xml(mbw_get_board_item('fn_category1',false));?>]]></category>
			<title><![CDATA[<?php echo esc_xml(mbw_htmlspecialchars_decode(mbw_get_board_item('fn_title',false)));?>]]></title>
