...
mbw_enqueue_style('smart-editor2-css', $editor_url.'css/ja_JP/smart_editor2.css');
				...
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="フォント"><span class="husky_se2m_current_fontName">フォント</span></button>
					...
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							...
							<li><button type="button"><span>NanumGothic<span>(</span><em style="font-family:'NanumGothic',NanumGothic,'Nanum Gothic';">あいうえお</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumMyungjo<span>(</span><em style="font-family:'NanumMyungjo',NanumMyeongjo,'Nanum Myeongjo';">あいうえお</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumGothicCoding<span>(</span><em style="font-family:'NanumGothicCoding',NanumGothicCoding,'Nanum Gothic Coding';">あいうえお</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumBarunGothic<span>(</span><em style="font-family:'NanumBarunGothic',NanumBarunGothic,'Nanum Barun Gothic';">あいうえお</em><span>)</span></span></button></li>
					...
					<div class="se2_layer" style="margin-left:-285px">
						<div class="se2_in_layer">
							<div class="se2_url2">
								...
								<label style="cursor:pointer !important;"><input  type="checkbox" value=""> <span style="vertical-align:2px">New Window</span></label>
							</div>
						</div>
					</div>
					<!-- //링크 -->
