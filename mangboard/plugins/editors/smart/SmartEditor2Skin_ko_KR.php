...
<link href="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/css/ko_KR/smart_editor2.css?ver=1.5.1" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
				...
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="글꼴"><span class="husky_se2m_current_fontName">글꼴</span></button>
					...
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							...
							<li><button type="button"><span>나눔고딕<span>(</span><em style="font-family:'나눔고딕',NanumGothic,'Nanum Gothic';">가나다라</em><span>)</span></span></button></li>
							<li><button type="button"><span>나눔명조<span>(</span><em style="font-family:'나눔명조',NanumMyeongjo,'Nanum Myeongjo';">가나다라</em><span>)</span></span></button></li>
							<li><button type="button"><span>나눔고딕코딩<span>(</span><em style="font-family:'나눔고딕코딩',NanumGothicCoding,'Nanum Gothic Coding';">가나다라</em><span>)</span></span></button></li>
							<li><button type="button"><span>나눔바른고딕<span>(</span><em style="font-family:'나눔바른고딕',NanumBarunGothic,NanumBarunGothicOTF,'Nanum Barun Gothic';">가나다라</em><span>)</span></span></button></li>
					...
					<div class="se2_layer" style="margin-left:-285px">
						<div class="se2_in_layer">
							<div class="se2_url2">
								...
								<label style="cursor:pointer !important;"><input  type="checkbox" value=""> <span style="vertical-align:2px">새창연결</span></label>
							</div>
						</div>
					</div>
					<!-- //링크 -->
