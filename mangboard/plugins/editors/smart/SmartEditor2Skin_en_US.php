...
mbw_enqueue_style('smart-editor2-css', $editor_url.'css/en_US/smart_editor2.css');
				...
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="Font"><span class="husky_se2m_current_fontName">Font</span></button>
					...
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							...
							<li><button type="button"><span>NanumGothic<span>(</span><em style="font-family:'NanumGothic',NanumGothic,'Nanum Gothic';">ABCD</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumMyungjo<span>(</span><em style="font-family:'NanumMyungjo',NanumMyeongjo,'Nanum Myeongjo';">ABCD</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumGothicCoding<span>(</span><em style="font-family:'NanumGothicCoding',NanumGothicCoding,'Nanum Gothic Coding';">ABCD</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumBarunGothic<span>(</span><em style="font-family:'NanumBarunGothic',NanumBarunGothic,'Nanum Barun Gothic';">ABCD</em><span>)</span></span></button></li>
