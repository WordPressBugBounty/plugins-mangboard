...
.pop_container2{padding:46px 60px 20px;text-align:center;}
.pop_container2 .dsc{margin-top:6px;color:#666;line-height:18px}
.pop_container2 .dsc strong{color:#13b72a}
.upload{margin:0 4px 0 0;_margin:0;padding:6px 0 4px 6px;border:solid 1px #d5d5d5;color:#a1a1a1;font-size:12px;border-right-color:#efefef;border-bottom-color:#efefef;length:300px;}
.mb-btn-default{margin:0;padding:6px 10px 5px;cursor:pointer !important;border: 1px solid #ccc;-webkit-border-radius:3px;-moz-border-radius:3px;-khtml-border-radius:3px;border-radius:3px;background-color:#FAFAFA !important;} 
...
<div id="pop_wrap">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <span class="mb-btn-default" id="btn_confirm">확인</span>
			<span class="mb-btn-default" id="btn_cancel">취소</span>
        </div>
    </div>
    <!-- //footer -->
</div>
