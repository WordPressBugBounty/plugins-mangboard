...
* PHP version 5.4.0 or greater (PHP 8.3 or greater is recommended)
...
* 보안 취약점 수정 [Wordfence에서 보안점검을 통해 알려주신 취약점 수정]
  => 2.5.2 보안 패치에서 보안 검증을 통과하지 못한 부분 수정
* minor bug 수정
...
= 2.3.9 =
* 카테고리 및 페이지네이션 버튼 클릭시 게시판 상단으로 페이지 스크롤 이동기능 추가
* 모델링 및 템플릿 확장 기능 수정
* minor bug 수정
