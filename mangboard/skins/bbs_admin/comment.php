...
<script type="text/javascript">
	...
	var comment_size				= <?php echo esc_js($comment_size); ?>;
	var comment_page_total		= <?php echo esc_js($comment_total_count); ?>;
	...
	function showCommentForm(action, pid, idx){
		...
		if(action=="delete"){
			...
			addHtml=addHtml+ '<form name="<?php echo esc_attr($mb_board_name);?>_form_comment_reply" id="<?php echo esc_attr($mb_board_name);?>_form_comment_reply" method="post" action="" onsubmit="return false;">';
	...
	function sendCommentDataHandler(response, state){
		...
		if(response.state == "success"){
			...
			var fn_pid						= <?php echo "'".esc_js($mb_fields["select_comment"]["fn_pid"])."'";?>;
			var fn_parent_pid				= <?php echo "'".esc_js($mb_fields["select_comment"]["fn_parent_pid"])."'";?>;
			var fn_reply						= <?php echo "'".esc_js($mb_fields["select_comment"]["fn_reply"])."'";?>;
			var fn_is_secret				= <?php echo "'".esc_js($mb_fields["select_comment"]["fn_is_secret"])."'";?>;
	...
	<div>
		...
		<div id="mb_comment_write_box" class="cmt-input-box">
			<div class="cmt-input-head">
				<form name="<?php echo esc_attr($mb_board_name);?>_form_comment_write" id="<?php echo esc_attr($mb_board_name);?>_form_comment_write" method="post" action="" onsubmit="return false;">
					<?php
