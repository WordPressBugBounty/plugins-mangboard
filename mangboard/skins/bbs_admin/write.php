<?php
	...
	if(mbw_get_param("board_action")=="modify" || mbw_get_param("board_action")=="reply" || mbw_get_param("board_action")=="copy"){
		...
		if(intval(mbw_get_board_item("fn_is_secret"))==1 && mbw_is_secret(array(mbw_get_board_item("fn_user_pid"),mbw_get_board_item("fn_parent_user_pid")),mbw_get_board_item("fn_passwd"))){
			require(MBW_SKIN_PATH."secret.php");return;
...
<input type="hidden" name="search_field" id="search_field" value="<?php echo esc_attr(mbw_get_param("search_field"));?>" />
<input type="hidden" name="search_text" id="search_text" value="<?php echo esc_attr(mbw_get_param("search_text"));?>" />

<input type="hidden" name="board_page" id="board_page" value="<?php echo esc_attr(mbw_get_param("board_page"));?>" />
<input type="hidden" name="board_action" id="board_action" value="<?php echo esc_attr(mbw_get_param("board_action"));?>" />
<input type="hidden" name="editor_type" id="editor_type" value="<?php echo esc_attr(mbw_get_board_option("fn_editor_type"));?>" />
...
?>
<input type="hidden" name="parent_pid" id="parent_pid" value="<?php echo esc_attr($parent_pid);?>" />
<input type="hidden" name="parent_user_pid" id="parent_user_pid" value="<?php echo esc_attr($parent_user_pid);?>" />

<?php if(mbw_get_param("board_action") == "reply"){?>
	<input type="hidden" name="board_gid" id="board_gid" value="<?php echo esc_attr(mbw_get_board_item("fn_gid"));?>" />
	<input type="hidden" name="board_reply" id="board_reply" value="<?php echo esc_attr(mbw_get_board_item("fn_reply"));?>" />
	<input type="hidden" name="reply_depth" id="reply_depth" value="<?php echo esc_attr(mbw_get_board_item("fn_reply_depth"));?>" />
	<input type="hidden" name="board_pid" id="board_pid" value="<?php echo esc_attr(mbw_get_param("board_pid"));?>" />
<?php }
...
?>
	<input type="hidden" name="calendar_date" id="calendar_date" value="<?php echo esc_attr($calendar_date);?>" />
<?php }
