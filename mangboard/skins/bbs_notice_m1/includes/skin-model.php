...
// Board Model
$desktop_model['list']		= '
{"type":"list_check","width":"30px","level":"8","class":"list_check"},
...
{"field":"fn_reg_date","name":"W_DATE","width":"110px","type":"date","class":"date","responsive":"mb-hide-mobile"},
...
{"field":"fn_title","name":"W_TITLE","width":"","type":"title_checkbox","maxlength":"80","maxtext":"..","td_class":"gallery-title"},
{"field":"fn_content","name":"W_CONTENT","type":"search"},
...
{"field":"fn_passwd","name":"W_PASSWORD","width":"150px","mobile_width":"99%","display_check":"login:hide","maxlength":"16","type":"password","required":"(*)","class":"mb-passwd"},
...
{"field":"fn_user_name","name":"W_WRITER","width":"157px","login":"cw_name","required":"(*)","class":"mb-user-name","filter":"filter_admin","filter_error":"MSG_NAME_UNUSABLE"},
{"field":"fn_passwd","name":"W_PASSWORD","width":"157px","login":"none","type":"password","required":"(*)","class":"mb-passwd"},
{"type":"kcaptcha_img","name":"W_KCAPTCHA","width":"70px","height":"30px","class":"kcaptcha","level":{"sign":"<","grade":"1"},"modify":"none","description":"<br>(MSG_CAPTCHA_INPUT)"},
...
$mobile_model['list']		= '
{"type":"list_check","width":"30px","level":"8","class":"list_check"},
{"field":"fn_title","name":"W_TITLE","width":"","type":"title_img","maxlength":"52","maxtext":"..","td_class":"list-title text-left"},
